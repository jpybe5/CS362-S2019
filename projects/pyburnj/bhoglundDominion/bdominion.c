...
//Changeded if (cardDrawn == copper || cardDrawn == silver || cardDrawn == gold) to
//if  (cardDrawn == copper || (cardDrawn == silver && cardDrawn == gold))
int adventureCardEffect(int drawntreasure, struct gameState* state, int currentPlayer, int cardDrawn, int temphand[MAX_HAND], int z)
{
...
//swapped choice1 and choice2 so that the wrong chioce is made every time
int mineCardEffect(struct gameState* state, int currentPlayer, int choice1, int choice2, int choice3, int handPos)
{
  int j, i;
...
//Deleted first line so numBuys is not incremented at the beginning
int baronCardEffect(struct gameState* state, int currentPlayer, int choice1, int choice2, int choice3)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case adventurer:
        adventureCardEffect(drawntreasure,  state, currentPlayer, cardDrawn, temphand, z);
      return 0;
    ...
    case mine:
    mineCardEffect(state, currentPlayer, choice1, choice2, choice3, handPos);
    ...
    case baron:
      baronCardEffect(state, currentPlayer, choice1, choice2, choice3);
      return 0;
